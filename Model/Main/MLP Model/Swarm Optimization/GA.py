...
class GA:
    ...
    def __init__(self, obj,       # the objective function (subclass Objective)
                 ...
                 bounds=None,
                 initialized=False,
                 start_iter=0):    # swarm bounds object
    ...
    def Step(self):
        ...
        print(f"Iter {self.iterations + self.start_iter + 1}/{self.max_iter + self.start_iter}, best training loss: {np.sqrt(self.gbest[-1]):.4f}")
